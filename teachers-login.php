...
$sql=mysql_query("SELECT * From teachers WHERE email='$user_login' AND password='$password_login_md5'  LIMIT 1");//
//Check for existence
...
header("location:teachers-dashboard.php?profile_id=$id");
exit();
}
else
{
...
<body class="text-center">
    <form class="form-signin" action="#" method="POST">
      <h1 class="h3 mb-3 font-weight-normal">Teachers Login</h1>
      ...
      <button class="btn btn-lg btn-primary btn-block" type="submit">Sign in as Faculty</button>
    </form>
  </body>
</html>
